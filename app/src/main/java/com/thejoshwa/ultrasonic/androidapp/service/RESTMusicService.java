...
public class RESTMusicService implements MusicService
{
	...
	{
		return executeJukeboxCommand(context, progressListener, Collections.singletonList("action"), Arrays.<Object>asList("get"));
	}
